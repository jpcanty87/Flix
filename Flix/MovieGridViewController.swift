...
class MovieGridViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let n = numberOfItemsPerRow
        let phoneWidth = Int(view.frame.size.width)
        let usableSpace = phoneWidth - ((n - 1) * Int(layout.minimumInteritemSpacing))
        let width = usableSpace / n
